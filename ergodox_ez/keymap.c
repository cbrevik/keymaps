 ...
 */
  [BASE] = LAYOUT_ergodox(
    ...
    NO_AT, KC_Y, KC_U, KC_I, KC_O, KC_P, NO_AA,
    ...
    // mid right
    KC_RALT, TD(TD_GRTR_GRTRCLOSE), KC_PGUP, KC_DEL, KC_BSPACE, KC_ENTER
  ),
 ...
 */
  [DEV] = LAYOUT_ergodox(
    ...
    NO_RCBR, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_F12,
